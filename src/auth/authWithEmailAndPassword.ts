 ...
 */
  import { getAuth, UserCredential, getIdTokenResult, signInWithEmailAndPassword, createUserWithEmailAndPassword } from "firebase/auth";
  import { getDatabase, ref, get, child } from "firebase/database";
  import firebase from "firebase/app";
  import { renderErrorModal } from "./renderErrorModal";
  
  export async function authWithEmailAndPassword(email: string, password: string): Promise<UserCredential | void> {
    const auth = getAuth();
